    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="" id="navbarDropdown" role="button" data-toggle="dropdown">For Hospital</a>
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="index.php">For User</a>
            <a class="dropdown-item" href="indexdoc.php">For Doctor</a>
          </div>
        </li>
        &nbsp;&nbsp;<li class="nav-item"><a class="btn btn-outline-success" href="login.php">Login/Signup</a></li>
    </div>
  </nav>
